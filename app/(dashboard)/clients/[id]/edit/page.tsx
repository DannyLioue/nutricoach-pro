...
export default function EditClientPage() {
  ...
  const fetchClient = async () => {
    try {
      ...
      const allergies = parseJsonArray(data.client.allergies);
      const medicalHistory = parseJsonArray(data.client.medicalHistory);
      const healthConcerns = parseJsonArray(data.client.healthConcerns);
      ...
      setFormData({
        ...
        userRequirements: data.client.userRequirements || '',
        exerciseDetails: data.client.exerciseDetails || '',
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log('[EDIT CLIENT] Submitting data:', submitData);
      ...
      const data = await res.json();
      console.log('[EDIT CLIENT] Response:', res.status, data);
